...
public class test extends TimePickerDialog
{
    ...
    public test (Context context, OnTimeSetListener callBack, int minutes, int seconds) {
    ...
    public void onAttachedToWindow() {
        ...
        try {
            ...
            int maxMinutes = 60;
            NumberPicker mHourSpinner = (NumberPicker)timePicker.findViewById(field.getInt(R.id.class));
